...
- Root completion Invocation ID 与 Completion Receipt v1 已实现并冻结：受限 ASCII CLI correlation、模型请求隔离、after-hook 安全传播、最终原子 receipt、artifact ledger 引用和公开 JSON Schema 已通过端到端测试。
